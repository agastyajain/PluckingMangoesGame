...
function setup() {
	...
	mango4 = new Mango(1190,100,30);
	mango5 = new Mango(1200,200,30);
	mango6 = new Mango(950,180,30);
  mango7 = new Mango(1260,180,30);
  tree = new Tree(1100,580);
  ground = new Ground(0,574,4000,20);
	boy = new Boy(250,470);
	chain = new Chain(stone.body,{x:160, y:380});
...
function draw() {
  ...
  fill('red');
  textSize(24);
  text("PRESS SPACE TO GET A SECOND CHANCE TO PLAY", 00,20);
  ground.display();
  tree.display();
  boy.display();
  stone.display();
